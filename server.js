// JobSlot AI — Jobber Proxy Server v3
// Deploy this to Render.com (free tier)
// Dates for the current week are injected automatically — no manual editing needed.
...
app.get("/", (req, res) => {
  ...
  res.json({
    status: "JobSlot AI Proxy running v3",
...
app.listen(PORT, () => console.log(`JobSlot AI Proxy v3 on port ${PORT}`));
